...
- the import sets the MCP gateway read timeout to `10m` via `engine.mcp.tool-timeout`; consumers do not need to set `sandbox.mcp.env.MCP_GATEWAY_TOOL_TIMEOUT` for the default Repo Mind Light path
